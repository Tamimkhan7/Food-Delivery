🍔Food Delivery Web Application | React.js Project
...
✨ Key Features
 • Home page with a clean, user-friendly UI
 • Menu listing for available food items
 • User login system
 • Cart-based ordering functionality
